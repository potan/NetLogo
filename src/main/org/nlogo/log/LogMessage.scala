...
class LogMessage private (val tag: String) {
  ...
  def updateCommandMessage(tpe: String, action: String, code: String, agentType: String, errorMessage: String, startPos: Int, endPos: Int) {
    attributes(0)(1) = tpe
  ...
  def updateCodeTabMessage(tpe: String, code: String, errorMessage: String, startPos: Int, endPos: Int) {
    attributes(0)(1) = tpe
