...
class PropertyAccessor[T : scala.reflect.ClassTag](val target: Editable, val displayName: String, val accessString: String) {
  ...
  def erasure = scala.reflect.ClassTag[T](target.getClass).runtimeClass
